            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="javascript:" class="text-nowrap logo-img">
                        <img data-src="<?php echo $this->config->item('images_uri');?>logos/kms-dark-logo.svg" class="dark-logo lazyload" alt="Logo-Dark" style="height: 40px;margin-left: -35px;">
                        <img data-src="<?php echo $this->config->item('images_uri');?>logos/kms-dark-logo.svg" class="light-logo lazyload" alt="Logo-light" style="height: 40px;margin-left: -35px;">
                    </a>
