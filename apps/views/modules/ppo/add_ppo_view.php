<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <?php echo form_open_multipart('ppo/addpo','id = "formvalidation"');?>
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-12 no-padding">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control tiny-po" name="txtDari">
                                        <strong>ARRIE WICAKSONO</strong>
                                        <br>Koperasi Metropolitan
                                        <br>Spinindo Building
                                        <br>Jl. KH. Wahid Hasyim 76
                                        <br>Jakarta Pusat
                                    </textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 col-md-offset-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txtPoNumber" class="form-control btn-block" value="<?php echo $ponumber;?>"/>
                                </div>
                            </div>
                            <div class="col-md-4 col-md-offset-1">
                                <div class="form-group">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><input id="ongkir" name="txtOngkir" type="text" class="form-control text-right"/></td>
                                    </tr>
                                    <tr>
                                        <td colspan="4" class="text-right"><strong>Grand Total</strong></td>
                                        <td><input type="text" name="txtGrandTotal" readonly class="form-control grand-total text-right"/></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                        <div class="col-md-12 no-padding">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Notes:</label>
                                    <textarea class="form-control tiny-po" name="txtNotes">
									<strong>Keterangan</strong> 
									<br>Pembayaran : Cash Before Delivery
									<br>Harga sudah termasuk PPN 10%
									<br>Harga sudah termasuk biaya kirim
                                    </textarea>
                                </div>
                            </div>
                        </div>
