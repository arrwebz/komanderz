      ...
      <div class="row">
		...
		<div class="col-md-4">
          <div class="box box-danger">
			...
			<div class="form-group">
				<label>Notes:</label>
				<textarea name="txtNotes" class="form-control" style="height:150px;" readonly><?php echo $notes; ?></textarea>
			</div>
			  <div class="form-group">
		...
		<div class="col-md-4">
          <div class="box box-danger">
            ...
            <div class="box-body">
			  <div class="form-group">
                <a href="<?php echo base_url().$this->router->fetch_class();?>" class="btn btn-success"><i class="fa fa-search"></i> Cari Invoice</a>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
