  ...
  <section class="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-12 invoice-col">
          <p id="copytext">*LAPORAN PRAKIRAAN PENCAIRAN DES DGS NON* <br/>
		  <?php echo $datenow; ?> Pukul <?php echo date( 'H:i', strtotime(date('Y-m-d H:i'))); ?></p>
		  *KOMET Forecasts Pencairan*
		  <br/>
		  ...
		  <br/>
			...
			<br/> 
			<br/> 
			Detail : <a href="https://kms.kopegtel-metropolitan.co.id/quickreport/frcst">https://kms.kopegtel-metropolitan.co.id/quickreport/frcst</a>  
			<br/>
			*Komanders* 
			<br/> 
			<hr/> 
      ...
      <!-- /.row -->
	  <h3 style="text-align: center;vertical-align: middle;">KOMET Collection Forecasts</h3> 
      <!-- Table row -->
      <div class="row">
        ...
        <div class="material-datatables">
				<?php if (count ( $kometmonthly ) > 0) { ?>
                        <table id="datatableskw" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                            <?php $i = 0; ?>
                            <?php foreach ( $kometmonthly as $kw ) { ?>
                                <?php $i++; ?>
                                <tr>
									<td><span class="label label-danger">KOMET</span></td>
      ...
      <!-- /.row -->
	  <hr/>
	  <h3 style="text-align: center;vertical-align: middle;">MESRA Collection Forecasts</h3>
      <!-- Table row -->
      <div class="row">
        <div class="material-datatables">
				<?php if (count ( $drdm ) > 0) { ?>
        ...
        <div class="material-datatables">
				<?php if (count ( $mesramonthly ) > 0) { ?>
                        <table id="datatablesmw" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                            <?php $i = 0; ?>
                            <?php foreach ( $mesramonthly as $mw ) { ?>
                                <?php $i++; ?>
                                <tr>
									<td><span class="label label-info">MESRA</span></td>
      ...
      <!-- /.row -->
	  <hr/> 
	  <!-- <h3 style="text-align: center;vertical-align: middle;">All Invoice > 30 days</h3> -->
      <!-- Table row -->
      <div class="row">
        <div class="material-datatables">
				<?php if (count ( $allinv30 ) > 0) { ?>
                        <table id="datatablesaln" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            <thead>
                            <tr>
								<th>Unit</th>
								<th>Invoice</th>
                            ...
                            <tbody>
                            <?php $i = 0; ?>
                            <?php foreach ( $allinv30 as $aln ) { ?>
                                <?php $i++; ?>
                                <tr>
									<td>
									<?php if ($aln['unit'] == 'KOMET') { ?>
									<span class="label label-danger"><?php echo $aln['unit'] ?></span>
									<?php } else { ?>
									<span class="label label-info"><?php echo $aln['unit'] ?></span>
									<?php } ?>
									</td>
									<td><?php echo $aln['invnum'] ?></td>
									<td><?php echo $aln['segment'] ?></td>
									<td>
                                    <?php if($aln['status'] == '2') { ?>
										<span class="label label-primary">Segmen</span>
									<?php } elseif($aln['status'] == '3') { ?>
										<span class="label label-warning">PJM</span>
									<?php } elseif($aln['status'] == '4') { ?>
										<span class="label label-warning">ASD</span>
									<?php } elseif($aln['status'] == '5') { ?>
										<span class="label label-success">Logistik</span>
									<?php } elseif($aln['status'] == '6') { ?>	
										<span class="label label-success">Keuangan</span>
									<?php } elseif($aln['status'] == '1') { ?>	
										<span class="label label-success">Cair</span>
									<?php } else { ?>
										<span class="label label-info">Terkirim</span> 
									<?php } ?>
									</td>
									<td><?php echo $aln['intervaldat']; ?> day</td>
                                    <td style="color: #fa591d;"><strong><?php echo strrev(implode('.',str_split(strrev(strval($aln['basevalue'])),3))); ?></strong></td>
                                </tr>
                            <?php }	?>
                            </tbody> 
                        </table>
