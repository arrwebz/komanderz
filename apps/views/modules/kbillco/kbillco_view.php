...
<section class="content">
    <div class="card card-hover">
        ...
        <?php echo form_open('kbillco/search');?>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        <label class="form-label fw-semibold">SPK / VSO</label>
                        <input name="txSpk" type="text" class="form-control">
                    </div>
                    <div class="form-group mb-4">
        ...
        <div class="col-md-12">
            <div class="card" style="margin-bottom:50px;">
                <div class="card-header d-flex align-items-center" style="background-color: #d72027; ">
                    <h4 class="card-title text-white mb-0">Invoice KOMET</h4>
                </div>
                                ...
                                <?php foreach ( $drd as $row ) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform: uppercase;">
                                            <a href="<?php echo base_url().$this->router->fetch_class(). '/details/'.$row['orderid']; ?>" style="color: #00bcd4;"><strong><?php echo $row['code']; ?></strong>
                                            </a>
                                        </td>
