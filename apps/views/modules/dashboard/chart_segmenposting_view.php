...
<div class="text-center">
    <p>Jumlah Total Invoice Posting : <?php echo array_sum(array_column($drd, 'total_inv'));?></p>
    <p>
        Jumlah Value Posting :
...
<div id="chartSegmenPosting" style="width: 100%;height: 500px;"></div>
...
<script>
    ...
    var chartPosting = am4core.create("chartSegmenPosting", am4charts.XYChart3D);
    chartPosting.data = <?php echo $drd_chart?>;

    // Modify chart's colors
    chartPosting.colors.list = [
    ...
    // Create axes
    var categoryAxis = chartPosting.xAxes.push(new am4charts.CategoryAxis());
    ...
    var valueAxis = chartPosting.yAxes.push(new am4charts.ValueAxis());
    ...
    // Create series
    var series = chartPosting.series.push(new am4charts.ColumnSeries3D());
    ...
    columnTemplate.adapter.add("fill", function(fill, target) {
        return chartPosting.colors.getIndex(target.dataItem.index);
    });
    ...
    chartPosting.cursor = new am4charts.XYCursor();
    chartPosting.cursor.lineX.strokeOpacity = 0;
    chartPosting.cursor.lineY.strokeOpacity = 0;
</script>