...
<div class="text-center">
    <p>Jumlah Total Invoice Verifikasi Keuangan : <?php echo array_sum(array_column($drd, 'total_inv'));?></p>
    <p>
        Jumlah Value Verifikasi Keuangan :
...
<div id="chartSegmenKeuangan" style="width: 100%;height: 500px;"></div>
...
<table class="table table-responsive table-bordered">
    ...
    echo '<thead>';
        echo '<tr>';
            echo '<td>Verifikasi Keuangan</td>';
...
<script>
    ...
    var chartKeuangan = am4core.create("chartSegmenKeuangan", am4charts.XYChart3D);
    chartKeuangan.data = <?php echo $drd_chart?>;

    // Modify chart's colors
    chartKeuangan.colors.list = [
    ...
    // Create axes
    var categoryAxis = chartKeuangan.xAxes.push(new am4charts.CategoryAxis());
    ...
    var valueAxis = chartKeuangan.yAxes.push(new am4charts.ValueAxis());
    ...
    // Create series
    var series = chartKeuangan.series.push(new am4charts.ColumnSeries3D());
    ...
    columnTemplate.adapter.add("fill", function(fill, target) {
        return chartKeuangan.colors.getIndex(target.dataItem.index);
    });
    ...
    chartKeuangan.cursor = new am4charts.XYCursor();
    chartKeuangan.cursor.lineX.strokeOpacity = 0;
    chartKeuangan.cursor.lineY.strokeOpacity = 0;
</script>