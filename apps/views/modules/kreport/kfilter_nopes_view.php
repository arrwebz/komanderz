      ...
      <div class="row">
        <div class="col-xs-12">
		  <div class="alert alert-info alert-dismissible">
			...
			Di bawah ini merupakan daftar NOPES KOMET berdasarkan filter data. Klik tombol Expor Excel untuk mengunduh data ke format Excel. 
		  </div>
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Hasil Filter NOPES KOMET.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
