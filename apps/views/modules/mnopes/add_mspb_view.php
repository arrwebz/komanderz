      ...
      <div class="row">
          <div class="col-md-12">
              <div class="alert alert-info alert-dismissible">
                  ...
                  Nomor SPB terakhir MESRA <?php echo $code_spb[0]['last_code_spb'];?>
              </div>
          </div>
		<?php echo form_open_multipart('mnopes/addspb');?>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
			  ...
			  <div class="form-group">
				...
				<input name="txtKodenomor" type="text" class="form-control">
              </div>
			  <div class="form-group">
