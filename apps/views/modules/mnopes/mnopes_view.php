                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="<?php echo site_url('mnopes');?>">Invoice MESRA</a>
                        </li>
                    </ol>
                </nav>
            </div>
...
<section class="content">
    <div class="card card-hover">
		...
		<?php echo form_open('mnopes/search');?>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group mb-4">
                        <label for="exampleInputname" class="form-label fw-semibold">SPK</label>
                            ...
                            <table id="datatables" class="table border table-striped table-bordered display text-nowrap table-hover" style="width: 100%">
                                ...
                                <?php foreach ( $drd as $row ) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-transform: uppercase;font-size: 12px;"><?php echo $row['orderstatus'] ?></td>
...
<script type="text/javascript">
	...
	$('.js-sweetalert button').on('click', function () {
		var current_url = "<?php echo base_url("mnopes");?>";
