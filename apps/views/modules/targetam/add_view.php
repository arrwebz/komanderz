...
<?php echo form_open('targetam/add');?>
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body p-4 border-bottom">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <label for="optSegment" class="form-label fw-semibold">Account Manager</label>
                            <select name="optAm" id="optAm" class="form-control selectpicker" >
