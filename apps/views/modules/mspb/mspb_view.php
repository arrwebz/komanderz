            ...
            <div class="col-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">MESRA</li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
...
<section class="content">
    <div class="card card-hover">
        ...
        <?php echo form_open('mspb/search');?>
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                        ...
                        <?php if (count ( $drd ) > 0) { ?>
                            <table id="datatables" class="table border table-striped table-bordered display text-nowrap">
                                ...
                                <?php foreach ( $drd as $row ) { ?>
                                    ...
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td style="text-transform: uppercase;"><a href="<?php echo base_url().$this->router->fetch_class(). '/details/'.$row['spbid']; ?>" style="color: #00bcd4;"><strong><?php echo $row['code'] ?></strong></a></td>
...
<script>
	$(function() {
		...
		$('#exportSPB').on('click', function(){
			...
			var link = '<?php echo site_url('mspb/export?')?>'+postData;
			window.location.href = link;
		});

		$('#xrtSPB').on('click', function(){
			var link = '<?php echo site_url('mspb/xreqspbtoday?')?>';
			window.location.href = link;
		});
	});
