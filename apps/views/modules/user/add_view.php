...
<?php echo form_open_multipart('user/add', 'class = "form-horizontal"');?>
<div class="row">
    <div class="col-12">
        <div class="card">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
							...
							<input name="txtPosition" type="text" class="form-control">
                        </div>
                        <div class="mb-4">
                            <label for="txtJoindate" class="form-label fw-semibold">Join Date</label>
							<input name="txtJoindate" type="date" class="form-control">
                        </div>
                        <div class="mb-4">
