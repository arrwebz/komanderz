        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="alert alert-info alert-dismissible">
                    ...
                    Silahkan ceklis SPB dibawah ini.
                </div>
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Approval SPB Padi tanggal <?php echo $tglapp; ?></h3>
                    </div>
                    <div class="box-body">
                        <div class="material-datatables icheck-blue">
                            <?php echo $this->session->flashdata('error'); ?>
                            <?php echo form_open('papproval/update');?>
                            ...
                            <?php if (count ( $drd ) > 0) { ?>
                                <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                    ...
                                    <?php foreach ( $drd as $row ) { ?>
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="aprv[]" value="<?php echo $row['spbid'].','.$row['staprvsek'].','.$row['staprvben'].','.$row['staprvket'] ?>"></td>
                                            <td style="color: #dd4b39;"><strong><?php echo $row['amname'] ?></strong></td>
