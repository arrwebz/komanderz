        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="alert alert-info alert-dismissible">
                    ...
                    Di bawah ini merupakan daftar PRPO PADI berdasarkan filter data. Klik tombol Expor Excel untuk mengunduh data ke format Excel.
                </div>
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Hasil Filter PRPO PADI.</h3>
                    </div>
                    <div class="box-body">
