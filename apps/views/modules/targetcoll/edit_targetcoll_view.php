...
<?php echo form_open_multipart('targetcoll/edittargetcoll/'.$idtargetcoll);?>
<input type="hidden" name="txtIdtargetcoll" value="<?php echo $idtargetcoll;?>"/>
<div class="row">
    <div class="col-12">
        <div class="card">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="optTipe" class="form-control selectpicker" style="width: 100%">
            ...
            <div class="card-body p-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <label for="optBulan" class="form-label fw-semibold">Year</label>
