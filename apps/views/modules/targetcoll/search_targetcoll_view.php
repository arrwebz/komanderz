<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="#">Target Collection</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">List Target Collection</h3>
                    </div>
                    <div class="box-body">
                                    ...
                                    <?php foreach ( $drd as $row ) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right js-sweetalert">
                                                ...
                                                <?php if($sess['role'] == 1): ?>
                                                    <a href="<?php echo site_url('targetcoll/edittargetcoll/'.$row['idtargetcoll']);?>" class="btn btn-xs btn-default edit-row">
                                                        <i class="fa fa-edit"> Ubah</i>
                                                    </a>
                                                    <button type="button" class="btn btn-xs btn-default delete-row" data-id="<?php echo $row['idtargetcoll'];?>" data-href="<?php echo base_url().$this->router->fetch_class(). '/delete'?>">
