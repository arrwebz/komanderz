  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tambah Aktiva</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Form isi pembuatan Aktiva Baru.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				<?php echo form_open_multipart('assets/add', 'class = "form-horizontal"');?>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input name="txtSeries" type="text" class="form-control">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea name="txtSpecs" type="text" class="form-control"></textarea>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input name="txtSerialnum" type="text" class="form-control">
                  </div>
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input name="txtAssetdate" type="text" class="form-control">
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <input id="idr" name="txtPrice" type="text" class="form-control">
                  </div>
                </div>
				<div class="form-group">
				...
				<div class="col-sm-3">
					<div class="input-group date">
					  <input type="text" name="txtPricedate" class="form-control pull-right datepicker">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-3">
						 ...
						 <select name="optLocation" class="form-control selectpicker">
								 <option disabled selected>Pilih</option>
								 <option value="spinindo building">Spinindo Building</option>
								 <option value="network plus">Network Plus</option>
								 <option value="menara multimedia">Menara Multimedia</option>
						 </select>
                  </div>
                </div>
				<div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea name="txtNotes" type="text" class="form-control"></textarea>
                  </div>
                </div>
				<div class="form-group">
