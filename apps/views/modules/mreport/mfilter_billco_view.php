  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">BILLCO MESRA</li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        <div class="col-xs-12">
		  <div class="alert alert-warning alert-dismissible">
			...
			Di bawah ini merupakan daftar COLLECTION MESRA berdasarkan filter data. Klik tombol Expor Excel untuk mengunduh data ke format Excel. 
		  </div>  
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Hasil Filter COLLECTION MESRA.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
				...
				<?php if (count ( $drd ) > 0) { ?>
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <?php foreach ( $drd as $row ) { ?>
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td style="text-transform: uppercase;"><a target='_blank' href="<?php echo base_url().'mbillco/details/'.$row['orderid']; ?>" style="color: #00bcd4;"><?php echo $row['code'] ?></a></td>
			...
			<div class="box-footer">
				...
				<?php echo form_open('mreportbco/exportfilter');?>
