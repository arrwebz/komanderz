      ...
      <div class="row">
        <div class="col-xs-12">
		  <div class="alert alert-info alert-dismissible">
			...
			Di bawah ini merupakan daftar NOPES MESRA berdasarkan filter data. Klik tombol Expor Excel untuk mengunduh data ke format Excel. 
		  </div>
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Hasil Filter NOPES MESRA.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			...
			<div class="box-footer">
				...
				<?php echo form_open('mreportnps/exportfilter');?>
