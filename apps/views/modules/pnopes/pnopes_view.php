...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Nopes <?php echo ucwords(strtolower($title));?></li>
        </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-default">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <?php echo form_open('pnopes/search');?>
                <div class="row">
                    <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title">Daftar invoice <?php echo ucwords(strtolower($title));?>.</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                            ...
                                            <td class="text-right js-sweetalert">
                                                ...
                                                <?php if(in_array($group, $nav)) { ?>
                                                    ...
                                                    <?php if(in_array($role, $navrole)) { ?>
														...
														<?php } else { ?>
														<small class="label label-primary">0</small>
														<?php } ?>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group label-floating">
                    <label class="control-label">AM <?php echo ucwords(strtolower($title));?></label>
