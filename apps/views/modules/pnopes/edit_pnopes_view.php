<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		<?php echo form_open_multipart('pnopes/editnopes');?>
		...
		<div class="col-md-4">
          ...
          <div id="docFakturPajak" class="col-md-4">
              <div class="box box-default">
                  ...
                  <div class="box-body">
                      <?php if(!empty($file)): ?>
                          <a href="<?php echo $this->config->item('uploads_uri').'fakturpajak/padi/'.$orderid.'/'.$file;?>" target="_blank" class="btn btn-block btn-social bg-purple" style="margin-bottom:20px;">
                              <i class="fa fa-file-pdf-o"></i> Faktur Pajak
                          </a>
                      <?php endif; ?>
                      <div class="form-group">
                          <label>Upload Faktur Pajak:</label>
                          <input name="txtFile" type="file" id="file" class="form-control">
                      </div>
                  </div>
              </div>
          </div>
