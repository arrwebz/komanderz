  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        ...
        <!-- /.col -->
          <div id="docFakturPajak" class="col-md-4">
              <div class="box box-default">
                  <div class="box-header with-border">
                  ...
                  <div class="box-body">
                      <?php if(!empty($file)): ?>
                          <a href="<?php echo $this->config->item('uploads_uri').'fakturpajak/padi/'.$id.'/'.$file;?>" target="_blank" class="btn btn-block btn-social bg-purple" style="margin-bottom:20px;">
                              <i class="fa fa-file-pdf-o"></i> Faktur Pajak
                          </a>
                      <?php endif; ?>
                  </div>
              </div>
		...
		<div class="col-md-4">
          <div class="box box-warning">
            ...
            <div class="box-body"> 
			<a target="_blank" href="<?php echo base_url().'ptrack/details/'.$id;?>"><i class="fa fa-binoculars"></i> Detail dokumen invoice</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
                            ...
                            <?php foreach ( $spbbyinvoice as $inv ) { ?>
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td> <td><?php if ($inv['code'] == "") {
										...
										echo "<a target='_blank' href=' ".base_url()."pspb/details/".$inv['spbid']."' style='color: #00bcd4;'><strong>".$inv['code']."</strong></a>"; } ?>
									</td>
                                    <td><?php if ($inv['value'] == "") {
										echo "<i style='color:red;'>Data belum diupdate.</i>";
									} else {
		...
		<?php } ?>
          ...
          <button type="button" class="btn btn-success pull-right" onClick="window.location.href = '<?php echo base_url();?>/pbillco/details/<?php echo $id; ?>';return true;">
