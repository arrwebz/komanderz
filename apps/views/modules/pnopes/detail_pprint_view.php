...
<br/>
  <table width="100%">
    <tr>
		...
		<td align="right"><?php if($unit == 'KOMET') echo '<strong>KOMET</strong>'; elseif($unit == 'MESRA') echo '<strong>MESRA</strong>'; elseif($unit == 'PADI') echo '<strong>PADI</strong>'; else echo 'Tidak Diketahui'; ?></td>
    </tr>
