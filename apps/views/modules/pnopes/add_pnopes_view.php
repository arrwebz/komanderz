<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		<?php echo form_open_multipart('pnopes/addnopes','id = "formvalidation"');?>
        <div class="col-md-4">
              ...
              <div class="form-group">
				...
				<div class="input-group">
						<span class="input-group-addon">
						  <input name="chkB2B" type="checkbox" value="B2B"> B2B
						</span>
					<input name="txtKodenomor" type="text" class="form-control" autocomplete="off" required>
				</div>
              </div>
			  <div class="form-group">
                <label>Nomor Invoice:</label>
				<input name="txtInvnum" id="txtInvnum" type="text" class="form-control" autocomplete="off">
				<div id="msg"></div>
              </div>
			  <div class="form-group">
				...
				<div class="input-group">
					<div class="input-group-addon">
                        <strong><?php echo $fakturpajak[0]['code'];?></strong>
					</div>
				<input name="txtFaknum" type="text" class="form-control" autocomplete="off">
					</div>
              </div>
			  <div class="form-group">
                <label>Nomor Tel/SPK/VSO PADI:</label>
				<input name="txtNopesnomor" type="text" class="form-control" autocomplete="off">
              </div>
			  <div class="form-group">
				...
				<input name="txtTglmsknopes" type="text" class="form-control datepicker" autocomplete="off">
				</div>
              </div>
			  <div class="form-group">
				...
				<input name="txtTglnopes" type="text" class="form-control datepicker" autocomplete="off">
				</div>
              </div>
			  <div class="form-group">
				...
				<input name="txtTglinv" type="text" class="form-control datepicker" autocomplete="off">
				</div>
              </div>
			  <div class="form-group">
				...
				<input name="txtTglkirim" type="text" class="form-control datepicker" autocomplete="off">
				</div>
              </div>
            </div>
            <!-- /.box-body -->
		...
		<div class="col-md-4">
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="form-group">
                <label>Unit:</label>
				<input name="optUnit" type="text" class="form-control" value="PADI" disabled>
              </div>
			  <div class="form-group">
                <label>Jenis Pekerjaan:</label>
				<select name="optJobtype" class="form-control selectpicker" autocomplete="off" readonly>
					<option value="PD" selected>PD</option>
				</select>
              </div>
			  <div class="form-group">
                <label>Divisi:</label>
				<select name="optDivision" id="optDivision" class="form-control selectpicker" autocomplete="off">
          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              <div class="form-group">
				...
				<input name="txtNilaidasar" type="text" id="idr1" class="form-control" autocomplete="off">
				</div>
              </div>
			  <div class="form-group">
				...
				<input name="txtNilaippn" type="text" id="idr2" class="form-control" autocomplete="off">
				</div>
              </div>
			  <div class="form-group">
				...
				<input name="txtNilainet" type="text" id="idr3" class="form-control" autocomplete="off">
				</div>
              </div>
            </div>
            <!-- /.box-body -->
	...
	$(document).ready(function() {
		...
		$("#txtInvnum").on("blur", function(e) {
			...
			if ($('#txtInvnum').val() == null || $('#txtInvnum').val() == "") {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('pnopes/ajaxcheckinvoice'); ?>",
