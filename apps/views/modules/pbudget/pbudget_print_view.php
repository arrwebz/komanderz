...
<table width="100%">
    <tr>
        <td align="center" <?php if($this->uri->segment('3') == '1576'): ?>style="font-size:10px;"<?php endif; ?>><?php if($unit == 'KOMET') echo '<h3>RINCIAN PENGELUARAN KOPERASI METROPOLITAN</h3>'; elseif($unit == 'MESRA') echo '<h3>RINCIAN PENGELUARAN PT. METROPOLITAN SEJAHTERA</h3>'; else echo '<h3>RINCIAN PENGELUARAN PADI UMKM</h3>'; ?></td>
    </tr>
</table>
...
<table border="1" width="100%" style="border-collapse: collapse; <?php if($this->uri->segment('3') == '1576'): ?>margin-top:45px;<?php endif; ?>">
    <thead style="background-color: lightgray;">
    <tr>
        <th></th>
        <th></th>
    ...
    <tr>
        <td><?php if($unit == 'KOMET') echo '123-00-0414731-2'; else echo '103-000-6886-382'; ?></td>
        <td align="center"></td>
        <td></td>
        <td></td>
        <td></td>
