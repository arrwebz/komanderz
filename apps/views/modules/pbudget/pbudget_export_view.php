...
<body>
 ...
 ?>
 <center>
		<h1><?php if($unit == 'KOMET') echo '<h3>RINCIAN PENGELUARAN KOPERASI METROPOLITAN</h3>'; elseif($unit == 'MESRA') echo '<h3>RINCIAN PENGELUARAN PT. METROPOLITAN SEJAHTERA</h3>'; else echo '<h3>RINCIAN PENGELUARAN PADI UMKM</h3>'; ?></h1>
	</center>
