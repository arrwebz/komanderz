                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="<?php echo site_url('tpayroll');?>">Payroll</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="col-md-12">
        <div class="card" style="margin-bottom:50px;">
            ...
            <div class="card-body collapse show">
                <div>
                    <a href="<?php echo base_url().$this->router->fetch_class().'/addpengurus'; ?>" class="btn rounded-pill waves-effect waves-light btn-outline-success px-4">+ Tambah Payroll Manual</a>
                    <a href="<?php echo base_url().$this->router->fetch_class().'/import'; ?>" class="btn rounded-pill waves-effect waves-light btn-outline-success px-4">+ Upload Payroll Koptel</a>
                </div>
...
<script>
	$(function() {
		...
		$('#formSearch').on('submit', function () {
			...
			$.ajax({
				type: "POST",
				url: '<?php echo site_url('tpayroll/search')?>',
