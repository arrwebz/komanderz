...
<section class="content">
    <div class="card card-hover">
        ...
        <?php echo form_open('targetsales/search');?>
        <div class="card-body">            
            <div class="row">
                <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="card" style="margin-bottom:50px;">
                ...
                <div class="card-body collapse show">
                    <p>
                        <a href="<?php echo base_url().$this->router->fetch_class().'/addtargetsales'; ?>" class="btn rounded-pill waves-effect waves-light btn-outline-success px-4">+ Add</a>
                    </p>
                                    ...
                                    <?php foreach ( $drd as $row ) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right js-sweetalert">
                                                ...
                                                <?php if($sess['role'] == 1): ?>
                                                    <a href="<?php echo site_url('targetsales/edittargetsales/'.$row['idtargetsales']);?>" class="btn mb-1 bg-warning-subtle btn-circle btn-sm d-inline-flex align-items-center justify-content-center edit-row">
                                                        <i class="fs-4 ti ti-edit text-warning"></i>
                                                    </a>
                                                    <button type="button" class="btn mb-1 bg-danger-subtle btn-circle btn-sm d-inline-flex align-items-center justify-content-center delete-row" data-id="<?php echo $row['idtargetsales'];?>" data-href="<?php echo base_url().$this->router->fetch_class(). '/delete'?>">
