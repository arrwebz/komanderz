        ...
        <div class="col-md-12">
            <div class="card" style="margin-bottom:50px;">
                <div class="card-header d-flex align-items-center" style="background-color: #d72027; ">
                    <h4 class="card-title text-white mb-0">Result</h4>
                </div>
                                ...
                                <?php foreach ( $drd as $row ) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right js-sweetalert">
                                            ...
                                            <?php if($sess['role'] == 1): ?>
                                                <a href="<?php echo site_url('mom/editmom/'.$row['momid']);?>" class="btn mb-1 bg-warning-subtle btn-circle btn-sm d-inline-flex align-items-center justify-content-center edit-row">
                                                    <i class="fs-4 ti ti-edit text-warning"></i>
                                                </a>
                                                <button type="button" class="btn mb-1 bg-danger-subtle btn-circle btn-sm d-inline-flex align-items-center justify-content-center delete-row" data-id="<?php echo $row['momid'];?>" data-href="<?php echo base_url().$this->router->fetch_class(). '/delete'?>">
