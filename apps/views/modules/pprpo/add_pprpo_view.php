<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tambah PRPO</li>
        </ol>
    </section>

    <section class="content">
        <div class="row">
            <?php echo form_open_multipart('pprpo/addprpo');?>
            <div class="col-md-6">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="txtNilaijst" type="text" id="idr1" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="txtProject" type="text" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
