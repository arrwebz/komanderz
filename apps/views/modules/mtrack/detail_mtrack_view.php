                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="<?php echo site_url('mtrack');?>">Tracking</a>
                        </li>
            ...
            <div class="card" style="margin-bottom:50px;">
                ...
                <div class="card-body">
                    <div class="box-body">
                        ...
                        <?php } else { ?>
                            <div class="form-group mb-2">
                                <label class="form-label fw-semibold">Nomor PRPO:</label>
...
<script>
	$(function() {
		...
		$("#btnSubmit").click(function() {
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('mtrack/ajaxposition'); ?>",
