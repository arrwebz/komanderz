										...
										<td class="text-right js-sweetalert">
											...
											<?php if(in_array($group, $nav)) { ?>
												...
												<?php if(in_array($role, $navrole)) { ?>
													...
													<a href="<?php echo base_url().$this->router->fetch_class(). '/editinvoice/'.$row['orderid']; ?>" class="btn mb-1 bg-warning-subtle btn-circle btn-sm d-inline-flex align-items-center justify-content-center" data-bs-toggle="tooltip" title="Edit">
