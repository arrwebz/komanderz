...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <?php echo form_open_multipart('invoice/addinvoice','id = "formvalidation"');?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input id="txtInvnum" name="txtInvnum" type="text" class="form-control" autocomplete="off" readonly>
                            <input id="txtInvnummust" type="hidden" >
                ...
                <div class="card-body p-4 border-bottom">
                    <table class="table">
                        <thead>
                            <tr>
                                <th width="3%">
                                    <button type="button" id="addItem" class="btn mb-1 bg-success btn-circle btn-md d-inline-flex align-items-center justify-content-center"></button>
                                </th>
	...
	$(document).ready(function() {
		...
		$("#txtInvnum").on("blur", function(e) {
			...
			if ($('#txtInvnum').val() == null || $('#txtInvnum').val() == "") {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo site_url('invoice/ajaxcheckinvoice'); ?>",
		...
		$('#addItem').on('click', function () {
			...
			$('#bodyItem').append(
                '<tr class="row-item" data-id="'+ tbodyRowCount +'">' +
                    ...
                    '<button type="button" class="btn btn-danger remove-item" data-id="'+tbodyRowCount+'"><i class="fs-4 ti ti-trash"></i></button>' +
                    '</td>' +
