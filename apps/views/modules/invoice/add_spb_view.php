...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Surat Perintah Bayar Invoicing</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-info alert-dismissible">
                    ...
                    <?php echo $segmenpt ?><br><?php echo $segmen ?>
                </div>
            </div>
            <?php echo form_open_multipart('invoice/addspb','id = "formvalidation"');?>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="txtKodenomor" name="txtKodenomor" value="<?php echo $gencode; ?>" type="text" class="form-control">
                            <div id="msg"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Kepada:</label>
                            <input name="txtCustomer" type="text" value="<?php echo $amuser.' ('.$segmen.')'; ?>" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Untuk Pembayaran:</label>
                            <textarea name="txtInfo" type="text" class="form-control" style="width:590px; height:260px;"><?php echo $namaproyek ?></textarea>
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <select id="optTipecek" name="optTipecek" class="form-control selectpicker" autocomplete="off" width="100%" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input name="txtValue" type="text" id="idr" value="<?php echo $nilainet; ?>" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="txtApplicant" type="text" value="<?php echo $amkomet; ?>" class="form-control">
                        </div>
                    </div>
                    <!-- /.box-body -->
                </div>
    ...
    $(document).ready(function() {
        ...
        $("#txtKodenomor").on("blur", function(e) {
            ...
            if ($('#txtKodenomor').val() == null || $('#txtKodenomor').val() == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('invoice/ajaxcheckspb'); ?>",
