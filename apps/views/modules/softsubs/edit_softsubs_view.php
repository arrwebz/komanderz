                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a class="text-muted text-decoration-none" href="<?php echo site_url('softsubs');?>">Software Subscription</a>
                        </li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <?php echo form_open_multipart('softsubs/editsoftsubs/'.$softsubsid);?>
            <input name="txtSoftsubsid" type="hidden" class="form-control" value="<?php echo $softsubsid;?>">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input name="txtProname" type="text" class="form-control" required value="<?php echo $productname;?>">
                        </div>
                        <div class="mb-4">
                            ...
                            <select name="optOrderby" class="form-control selectpicker" >
                                ...
                                foreach($user as $row){
                                    $sel = '';
                                    if($row['userid'] == $orderby){
                                        $sel = 'selected';
                                    }

                                    echo '<option value="'.$row['userid'].'" '. $sel .'>'.$row['fullname'].'</option>';
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input name="txtEmail" type="text" class="form-control" required value="<?php echo $email;?>">
                        </div>
                        <div class="mb-4">
                            <label for="txtPassword" class="form-label fw-semibold">Password</label>
                            <input name="txtPassword" type="text" class="form-control" required value="<?php echo $password;?>">
                        </div>
                        <div class="mb-4">
                            <label for="txtNolis" class="form-label fw-semibold">License</label>
                            <input name="txtNolis" type="text" class="form-control" required value="<?php echo $nolis;?>">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input name="optCurrency" type="text" class="form-control" required value="<?php echo $currency;?>">
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Payment</label>
                            <select name="optTypeofpay" class="form-control selectpicker" >
                                <option disabled selected>Select</option>
                                <option value="cc" <?php if($typeofpayment == 'cc'){ echo 'selected'; }?>>CC</option>
                                <option value="transfer" <?php if($typeofpayment == 'transfer'){ echo 'selected'; }?>>Transfer</option>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Card</label>
                            <input name="txtCardnum" type="text" class="form-control" required value="<?php echo $cardnumber;?>">
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Start</label>
                            <input name="txtStartsubs" type="date" class="form-control" required value="<?php echo date('Y-m-d', strtotime($startsubs));?>">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Price</label>
                            <input name="txtSoftsubsval" type="text" class="form-control" required value="<?php echo $softsubsvalue;?>">
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Bank</label>
                            <input name="txtPayname" type="text" class="form-control" required value="<?php echo $paymentname;?>">
                        </div>
                        <div class="mb-4">
                            <label for="txtNolis" class="form-label fw-semibold">Plans</label>
                            <select name="optTypesubs" class="form-control selectpicker" >
                                <option disabled selected>Select</option>
                                <option value="tahunan" <?php if($typesubs == 'tahunan'){ echo 'selected'; }?>>Tahunan</option>
                                <option value="bulanan" <?php if($typesubs == 'bulanan'){ echo 'selected'; }?>>Bulanan</option>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">End</label>
                            <input name="txtEndsubs" type="date" class="form-control" required value="<?php echo date('Y-m-d', strtotime($endsubs));?>">
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Reminder:</label>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <input name="txtReminder" type="checkbox" <?php if($reminder == 'on'){ echo 'checked'; }?> value="<?php echo $reminder;?>">
                                </span> &nbsp;&nbsp;ingatkan saya?
                            </div>
                        </div>
                    </div>
...
<script>
    $(function() {
	    ...
	    user_tags.tagsinput('add', { "value": <?php echo $listuser[$i]['value']?>, "text": "<?php echo $listuser[$i]['text']?>"});
        <?php endfor; ?>
        <?php endif; ?>
