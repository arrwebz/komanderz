...
<section class="content">
    <div class="row">
        <div class="col-md-4">
            <div class="card" style="margin-bottom:50px;">
                <div class="card-header d-flex align-items-center text-bg-success">
                    <h4 class="card-title text-white mb-0">Close Invoice</h4>
                </div>
                <div class="card-body">
                    <form id="formvoucher" method="POST" action="javascript:">
                        ...
                        <div class="form-group mb-4">
                            <label class="form-label fw-semibold">Payment Value</label>
                            <input name="txtNilai" id="idr" type="text" class="form-control" value="<?php echo $nilaivoucher ?>" <?php //if ($statusinvoice != '6') echo 'disabled' ?>>
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label fw-semibold">Processing Date</label>
                            <input name="txtDateproc" type="date" class="form-control" value="<?php echo $tglcair ?>" <?php //if ($statusinvoice != '6') echo 'disabled' ?>>
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label fw-semibold">Payment Status</label>
                            <select name="optStatus" class="form-control selectpicker" style="width: 100%">
                                <option value="1" <?php if($statusinvoice == '1') echo 'selected' ?>>Paid</option>
                                <option value="9" <?php if($statusinvoice == '9') echo 'selected' ?>>Cancel</option>
                            </select>
                        </div>
                ...
                <div class="card-body">
                    <div class="box-body">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <textarea type="text" class="form-control" style="height:100px;" disabled><?php echo $namaproyek ?></textarea>
                        </div>
                        <?php if($inv != 0) { ?>
                            <div class="form-group mb-2">
        ...
        <div class="col-md-4">
            <div class="card" style="margin-bottom:50px;">
                <div class="card-header d-flex align-items-center text-bg-warning">
                                ...
                                <?php foreach ( $spbbyinvoice as $spb ) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if ($spb['code'] == "") { 
                                                ...
                                                echo "<a target='_blank' href=' ".base_url()."mspb/details/".$spb['spbid']."' style='color: #00bcd4;'><strong>".$spb['code']."</strong></a>"; } ?>
                                        </td>
                                    </tr>
                                <?php }	?>
                                </tbody>
        ...
        <div class="col-md-8">
            <div class="card" style="margin-bottom:50px;">
                <div class="card-header d-flex align-items-center text-bg-success">
                    <h4 class="card-title text-white mb-0">Billing Status</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive pb-9">
                        ...
                        <?php } else { echo 'Invoice status not exist yet!'; }?>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Modal -->
<div id="Modalstatus" class="modal fade" aria-hidden="true" aria-labelledby="modalAddPacklaring" role="dialog">
    <div class="modal-dialog modal-simple modal-lg">
        <div class="modal-content">
            <div class="modal-header d-flex align-items-center" style="background-color: #d72027; border-top-right-radius: 15px; border-top-left-radius: 15px;">
                <h4 class="modal-title text-white" id="myLargeModalLabel">Perbarui Status Penagihan</h4>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#btnSubmit").click(function() {
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('mbillco/ajax_voucher'); ?>",
