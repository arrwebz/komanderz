...
<table width="82%" style="margin:0 auto;">
    ...
    <tr>
        <td colspan="2">
            <span class="text-left">Benar-benar telah menjadi Tenaga Kerja Outsourching Koperasi Metropolitan yang ditempatkan di PT. Telekomunikasi Indonesia, Tbk – sejak <strong class="color-black"><?php echo onlydate($drd[0]['start_work']);?></strong> sampai <strong class="color-black"><?php echo onlydate($drd[0]['end_work']);?></strong> dan selama menjalankan tugas berkelakuan baik.</span>
        </td>
    </tr>
    <tr>
        <td colspan="2" class="space"></td>
    ...
    <tr>
        <td colspan="2">
            <span class="text-left">Dan terhitung tanggal <strong class="color-black"><?php echo onlydate($drd[0]['nextmonth']);?></strong> sudah tidak aktif lagi sebagai tenaga kerja di Koperasi Metropolitan.</span>
        </td>
    </tr>
    <tr>
        <td colspan="2" class="space"></td>
    ...
    <tr>
        <td colspan="2"  style="height:80px;">
            <img src="<?php echo $_SERVER["DOCUMENT_ROOT"]; ?>/public/assets/dist/img/ttd-cap-ketua.png" alt="" height="100px" />
        </td>
    </tr>
    <tr>
        <td colspan="2">
