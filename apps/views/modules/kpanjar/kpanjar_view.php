...
<section class="content">
    <div class="card card-hover">
        ...
        <?php echo form_open('kprpo/search');?>
        <div class="card-body">            
            <div class="row">
                <div class="col-md-6">
        ...
        <div class="card-footer">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <button type="button" id="xrtExcel" class="btn rounded-pill waves-effect waves-light btn-success px-4 mb-6">
                        <div class="d-flex align-items-center">
                            <i class="ti ti-download me-2 fs-4"></i> Excel
                        </div>
                    </button>
                </div>
            </div>		
                            ...
                            <table id="datatables" class="table border table-striped table-bordered display text-nowrap table-hover" style="width: 100%"> 
								...
								<?php foreach ( $drd as $row ) { ?>
									...
									<tr>
										...
										<td style="color: #fa591d;"><strong><?php echo strrev(implode('.',str_split(strrev(strval($row['jstvalue'])),3))); ?></strong></td>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		$('#xrtExcel').on('click', function(){
			var link = '<?php echo site_url('kprpo/xrtdownload?')?>';
