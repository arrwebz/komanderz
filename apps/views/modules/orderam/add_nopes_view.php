            ...
            <div class="col-9">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">Accept Request</li>
                    </ol>
                </nav>
            </div>
            <div class="col-3">
    ...
    <div class="col-12">
        <div class="card">
            <div class="px-4 py-3 border-bottom">
                <h5 class="card-title fw-semibold mb-0">Accept Form</h5>
            </div>
            <?php echo form_open_multipart('orderam/addnopes');?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="optOrderinv" value="<?php echo $orderinv;?>"/>
                            <select name="" class="form-control selectpicker" style="width: 100%" disabled>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="txtTglmsknopes" type="date" class="form-control datepicker" autocomplete="off" value="<?php echo $tglmskspk; ?>" readonly>
                            </div>
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Nomor Tel/SPK/VSO PADI</label>
                            <input name="txtNopesnomor" type="text" class="form-control" value="<?php echo $nomorspk; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Tipe Order</label>
                            <input type="hidden" name="optOrderstatus" value="<?php echo $statusorder;?>"/>
                            <select name="" class="form-control selectpicker" style="width: 100%" disabled>
                                <option disabled selected>Pilih</option>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text"><i class="ti ti-calendar"></i></span>
                                <input name="txtTglnopes" type="date" class="form-control datepicker" autocomplete="off" value="<?php echo $tglspk; ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="optUnit" value="<?php echo $unit;?>"/>
                            <select name="" class="form-control selectpicker" style="width: 100%" disabled>
                                <option disabled selected>Pilih</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="optDivision" value="<?php echo $divisi;?>"/>
                            <select name="" id="optDivision" class="form-control selectpicker" style="width: 100%" disabled>
                                <option disabled selected>Pilih</option>
                                <?php
                        ...
                        <div class="mb-4">
                            ...
                            <input name="txtProject" type="text" class="form-control" style="height:108px" value="<?php echo $namaproyek; ?>" readonly>
                    ...
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="optJobtype" value="<?php echo $jp;?>"/>
                            <select name="" class="form-control selectpicker" style="width: 100%" disabled>
                                <option disabled selected>Pilih</option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="hidden" name="optSegment" value="<?php echo $segmen;?>"/>
                            <select name="" class="form-control selectpicker" style="width: 100%" disabled>
                                <option disabled selected>Pilih</option>
                                <?php
                        ...
                        <div class="mb-4">
                            ...
                            <?php }elseif(in_array($amkomet, listsupportam())){ ?>
                                <input type="hidden" name="txtAmkomet" value="<?php echo $amkomet;?>"/>
                                <select name="" id="txtAmkomet" class="form-control selectpicker" style="width: 100%" disabled>
                                    <option disabled selected>Pilih</option>
                                    <?php
                                    if(!empty($marketing)){
                    ...
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input name="txtNilaidasar" type="text" id="idr1" class="form-control" value="<?php echo $nilaidasar; ?>" readonly>
                            </div>
                        </div>
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input name="txtNilainet" type="text" id="idr3" class="form-control" value="<?php echo $nilaippn; ?>" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Rp</span>
                                <input name="txtNilaippn" type="text" id="idr2" class="form-control" value="<?php echo $nilainet; ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body p-4 border-bottom">
                <h5 class="fs-4 fw-semibold mb-4">Invoice</h5>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Number Invoice</label>
                            <input name="txtInvnum" type="text" class="form-control" value="<?php echo $inv; ?>">
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Date Invoice</label>
                            <div class="input-group">
                                <div class="input-group-text">
                                    <i class="ti ti-calendar"></i>
                                </div>
                                <input name="txtTglinv" type="date" class="form-control datepicker" value="<?php echo $tglinv; ?>" autocomplete="off">
                            </div>
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Number Faktur Pajak</label>
                            <div class="input-group">
                                <div class="input-group-text">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-4">
                            <label class="form-label fw-semibold">System Code</label>
                            <input name="txtKodenomor" type="text" class="form-control" value="<?php echo $kodenomor; ?>" required>
                        </div>
                        <div class="mb-4">
                            <label class="form-label fw-semibold">Date Send</label>
                            <div class="input-group">
                                <div class="input-group-text">
                                    <i class="ti ti-calendar"></i>
                                </div>
                                <input name="txtTglkirim" type="date" class="form-control datepicker" value="<?php echo $tglkrm; ?>" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
