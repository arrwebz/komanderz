...
class Tpinjaman extends CI_Controller {
    ...
    private function bindskins(){
        $css_head = array(
            ...
            array($this->config->item('skins_uri').'libs/magnific-popup/dist/magnific-popup.css'),
        );
        $js_head = array(
        ...
        $js_content  = array(
            ...
            array($this->config->item('skins_uri').'libs/magnific-popup/dist/jquery.magnific-popup.min.js'),
            array($this->config->item('skins_uri').'js/plugins/meg.init.js'),
    ...
    function index(){
        ...
        $data['content'] = $this->load->view('modules/tpinjaman/tpinjaman_view', $data, TRUE);
    ...
    function search(){
        if($_POST){
            $post = $_POST;
            $drd = $this->pinjamanmd->getallpinjaman($post);
            ...
            $this->load->view('modules/tpinjaman/tpinjaman_data', $data, FALSE);
        }else{
    ...
    function updatestatus() {
        if (isset($_POST['cmdsave'])) {
            ...
            if(!empty($_FILES['txtBuktitf']['name'])){
                ...
                $this->pinjamanmd->strnominal_pinjaman = $this->input->post('txtNominalspb');
