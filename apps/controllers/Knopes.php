...
class Knopes extends CI_Controller
{
    //kode arsip
    public $intorderid;
    public $intarcoid;
    ...
    public function index() {
        $data = [
            'drd' => $this->ordermd->getallorder(),
            'segment' => $this->drdmd->getallseg(),
            'title' => 'Invoice | KOMET',
            'brand' => 'Daftar Invoice',
        ...
        $data['content'] = $this->load->view('modules/korder/korder_view', $data, TRUE);
    ...
    public function addnopes() {
        if (isset($_POST['cmdsave'])) {
            ...
            $this->form_validation->set_rules('optOrderstatus', 'Order Type', 'required', $error);
            $this->form_validation->set_rules('txtNopesnomor', 'Tel/SPK/VSO PADI', 'required', $error);
            $this->form_validation->set_rules('txtAmuser', 'Pic Customer', 'required', $error);
            $this->form_validation->set_rules('txtNilaidasar', 'Base Value', 'required', $error);
        ...
        $data = [
            ...
            'lastinvnum' => $this->ordermd->getlastinvnum(),
