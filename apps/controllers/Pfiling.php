...
class Pfiling extends CI_Controller
{
    public $intspbid;
    public $intorderid;
    public $strcode;
    ...
    public function index() {
        $data = [
            'drd' => $this->spbmd->getmyfiling($this->session->userdata('userid'),'PADI'),
            'drp' => $this->spbmd->getpfiling('PADI'),
        ...
        $data['content'] = $this->load->view('modules/pfiling/pfiling_view', $data, TRUE);
    ...
    public function addnew() {
        $data = [
            ...
            'drd' => $this->spbmd->getmyspbbyinvoicetoday('PADI'),
            'tnk' => $this->repmd->countnopeskomet(),
            'tpk' => $this->repmd->countprpokomet(),
            'tsk' => $this->repmd->countspbkomet(),
            'tnm' => $this->repmd->countnopesmesra(),
        ...
        $data['content'] = $this->load->view('modules/pfiling/pfiling_add_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function myreqspb() {
        ...
        $data['content'] = $this->load->view('modules/pfiling/pfiling_today_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function appspb() {
        ...
        $data['content'] = $this->load->view('modules/pfiling/pfiling_app_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
