...
class Preportprpo extends CI_Controller
{
    ...
    public function index() {
		$data = [ 
			'drdnday' => json_encode($this->repmd->getreportprpoperday('PADI')),
			'drdnmonth' => json_encode($this->repmd->getreportprpopermonth('PADI')),
		...
		//echo json_encode($this->repmd->getreportprpoperday('PADI')); exit;
		
		$data['content'] = $this->load->view('modules/preport/preport_prpo_view', $data, TRUE);
	...
	public function reportfilter() {
		...
		$data['content'] = $this->load->view('modules/preport/pfilter_prpo_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	...
	public function exportfilter(){
		...
		$data = array( 'title' => 'Laporan Kontrak Padi : '.$strftitle,
                'drd' => $this->repmd->getreportprpo($unit,$division,$segment,$statspb,$statinv,$fdate,$edate)); 
		/* $data = $this->repmd->getreportkomet();
		echo '<pre>';  
		print_r($data); exit; */
           $this->load->view('modules/preport/pexport_prpo_view',$data);
	}	 
