...
class Kreportbco extends CI_Controller
{
    ...
    public function index() {
		$data = [ 
			'drdnday' => json_encode($this->repmd->getreportbillcoperday('KOMET')),
			'drdnmonth' => json_encode($this->repmd->getreportbillcopermonth('KOMET')),
		...
		$data['content'] = $this->load->view('modules/kreport/kreport_billco_view', $data, TRUE);
	...
	public function reportfilter() {
		...
		//var_dump($fdate); exit;	
		/*$sql = $this->repmd->getreportbillco($unit,$strmonth);
		echo '<pre>';
		print_r($sql); exit; */
		...
		$data['content'] = $this->load->view('modules/kreport/kfilter_billco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	...
	public function exportfilter(){
		...
		$strftitle = $strmonth.'/KOMET';
		$data = array( 'title' => 'Laporan Collection Komet : '.$strftitle,
                'drd' => $this->repmd->getreportbillco($unit,$strmonth)); 
		/* $data = $this->repmd->getreportkomet();
		echo '<pre>';  
		print_r($data); exit; */
           $this->load->view('modules/kreport/kexport_billco_view',$data);
	}	 
