...
class Mbudget extends CI_Controller
{
	public $intspbid;
	public $intorderid;
	public $strcode;
    ...
    public function index() {
		$data = [ 
			'drd' => $this->spbmd->getallbudget('MESRA'),
		...
		$data['content'] = $this->load->view('modules/mbudget/mbudget_view', $data, TRUE);
	...
	public function addnewbudget() {
		$data = [ 
			...
			'drd' => $this->spbmd->getallspbbyinvoicetoday('MESRA'),
		...
		$data['content'] = $this->load->view('modules/mbudget/mbudget_add_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	}
	...
	public function createbudget()
    {
		if ($this->input->post()) {
			...
			redirect(base_url().'mbudget/todaybudget/'.$budgetid);
			}
		}
    }
	...
	public function todaybudget() {
		...
		$data['content'] = $this->load->view('modules/mbudget/mbudget_today_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	}
	...
	public function preview() {
		...
		$name = 'Budget-MESRA-'.$fdatename.'.pdf';
		...
		//Load html view
	    //$this->html2pdf->html($this->load->view('modules/mbudget/mbudget_print_view', $data, true));
		...
		// Get output html
        $html = $this->load->view('modules/mbudget/mbudget_print_view', $data, true);
    ...
    function previewspb(){
        ...
        $html = $this->load->view('modules/mbudget/mbudget_printspb_view', $data, true);
    ...
    function previewinvoice() {
        ...
        // Get output html
        $html = $this->load->view('modules/mbudget/mbudget_printinv_view', $data, true);
	...
	public function export() {
		...
		/* echo '<pre>';
		print_r($rowspb); exit; */
		$fdate = date('d F Y', strtotime($this->strbudgetdate));	
		$fname = 'Anggaran-MESRA-'.$fdate;
		...
		/* echo '<pre>';  
		print_r($data); exit; */
        $this->load->view('modules/mbudget/mbudget_export_view',$data);
