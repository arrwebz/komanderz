...
class Ptrack extends CI_Controller
{
    ...
    public function index() {
        ...
        if($this->session->userdata('userid') == '21' || $this->session->userdata('userid') == '30' || $this->session->userdata('userid') == '36' || $this->session->userdata('userid') == '37' ) {
            $drd = $this->trkmd->getallinvoicebyam($amname,'PADI');
        } else {
            $drd = $this->trkmd->getallinvoice('PADI');
        }
        ...
        $data['content'] = $this->load->view('modules/ptrack/ptrack_view', $data, TRUE);
    ...
    public function details() {
        ...
        $data['content'] = $this->load->view('modules/ptrack/detail_ptrack_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
