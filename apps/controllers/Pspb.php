...
class Pspb extends CI_Controller
{
    public $intspbid;
    public $intorderid;
    public $strcode;
    ...
    public function index() {
        ...
        $data['content'] = $this->load->view('modules/pspb/pspb_view', $data, TRUE);
    ...
    public function search() {
        ...
        $data['content'] = $this->load->view('modules/pspb/search_pspb_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function export(){
        ...
        $strftitle = $segment.'/'.$spbmonth.'/'.$spbyear.'/PADI';
        $data = array( 'title' => 'Hasil Pencarian SPB Padi : '.$strftitle,
            'drd' => $this->spbmd->getsearchspb($unit,$segment,$spbyear,$spbmonth,$spbnum));
        /* $data = $this->repmd->getreportkomet();
        echo '<pre>';
        print_r($data); exit; */
        $this->load->view('modules/pspb/export_pspb_view',$data);
    }
    ...
    public function details() {
        ...
        $data['content'] = $this->load->view('modules/pspb/detail_pspb_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function preview() {
        ...
        // Get output html
        $html = $this->load->view('modules/pspb/detail_pprint_view', $data, true);
...
//        echo "<pre>"; print_r($data); echo "</pre>";exit;
        ...
        // Get output html
        $html = $this->load->view('modules/pspb/detail_pvoucher_view', $data, true);
    ...
    public function editspb() {
        ...
        $data['content'] = $this->load->view('modules/pspb/edit_pspb_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function updatestatus() {
		...
		$data['content'] = $this->load->view('modules/pspb/update_pstatus_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
