...
class Pbillco extends CI_Controller
{
    public $intbillcoid;
    public $intorderid;
    public $strposition;
    ...
    public function index() {
        $data = [
            'drd' => $this->billcomd->getallinvpadi(),
        ...
        $data['content'] = $this->load->view('modules/pbillco/pbillco_view', $data, TRUE);
    ...
    public function search() {
        ...
        $data = [
            'drd' => $this->billcomd->getsearchnopesbillco($unit,$invnum,$faknum,$segmen,$invmonth,$invyear,$spk),
            'title' => 'PADI',
            'brand' => 'Collection',
            'tnk' => $this->repmd->countnopeskomet(),
            'tpk' => $this->repmd->countprpokomet(),
        ...
        $data['content'] = $this->load->view('modules/pbillco/search_pbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function details() {
        ...
        $data['content'] = $this->load->view('modules/pbillco/detail_pbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function voucher() {
        ...
        // Get output html
        $html = $this->load->view('modules/pbillco/voucher_pbillco_view', $data, true);
    ...
    public function updatestatus() {
        ...
        $data['content'] = $this->load->view('modules/pbillco/status_pbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function updateposting() {
        if (isset($_POST['cmdsave'])) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                redirect(base_url() . 'pbillco/details/' . $invoiceid);
        ...
        $data['content'] = $this->load->view('modules/pbillco/updatepost_pbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
}