...
class Mbillco extends CI_Controller
{
	...
	public function index() {
		$data = [ 
			'drd' => $this->billcomd->getallinvmesra(),
		...
		$data['content'] = $this->load->view('modules/mbillco/mbillco_view', $data, TRUE);
	...
	public function search() {
		...
		$data = [ 
			'drd' => $this->billcomd->getsearchnopesbillco($unit,$invnum,$faknum,$segmen,$invmonth,$invyear,'',$status),
			'title' => 'MESRA',
			'brand' => 'Collection',
			'tnk' => $this->repmd->countnopeskomet(),
			'tpk' => $this->repmd->countprpokomet(),
		...
		$data['content'] = $this->load->view('modules/mbillco/search_mbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
	...
	public function details() {
		...
		$data['content'] = $this->load->view('modules/mbillco/detail_mbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	}
	...
	public function voucher() {
        ...
        //Load html view
	    //$this->html2pdf->html($this->load->view('modules/mbillco/voucher_mbillco_view', $data, true));
		...
		// Get output html
        $html = $this->load->view('modules/mbillco/voucher_mbillco_view', $data, true);
	...
	public function updatestatus() {
		...
		$data['content'] = $this->load->view('modules/mbillco/status_mbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	}	
	...
	if (isset($_POST['cmdsave'])) {
		$error = [
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                redirect(base_url() . 'mbillco/details/' . $invoiceid);
		...
		$data['content'] = $this->load->view('modules/mbillco/updatepost_mbillco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	}
