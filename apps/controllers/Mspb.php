...
class Mspb extends CI_Controller
{
	public $intspbid;
	public $intorderid;
	public $strcode;
    ...
    public function index() {
		if($this->session->userdata('userid') == '3'){
			$drd = $this->spbmd->getallspbmesrafinco();
		} else {
			$drd = $this->spbmd->getallspbmesra();
		}
		$data = [ 
			'drd' => $drd,
		...
		$data['content'] = $this->load->view('modules/mspb/mspb_view', $data, TRUE);
	...
	public function search() {
		...
		$arrsrc = $this->spbmd->getsearchspb($unit,$segment,$spbyear,$spbmonth,$spbnum);
		...
		$data['content'] = $this->load->view('modules/mspb/search_mspb_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
	...
	public function export(){
		...
		$strftitle = $segment.'/'.$spbmonth.'/'.$spbyear.'/MESRA';
		$data = array( 'title' => 'Hasil Pencarian SPB MESRA : '.$strftitle,
                'drd' => $this->spbmd->getsearchspb($unit,$segment,$spbyear,$spbmonth,$spbnum));
		/* $data = $this->repmd->getreportkomet();
		echo '<pre>';  
		print_r($data); exit; */
           $this->load->view('modules/mspb/export_mspb_view',$data);
	}
	...
	public function details() {
		...
		$data['content'] = $this->load->view('modules/mspb/detail_mspb_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	}
	...
	public function preview() {
		...
		//Load html view
	    //$this->html2pdf->html($this->load->view('modules/mspb/detail_mprint_view', $data, true));
		...
		// Get output html
        $html = $this->load->view('modules/mspb/detail_mprint_view', $data, true);
	...
	public function voucher() {
		...
		//Load html view
	    //$this->html2pdf->html($this->load->view('modules/mspb/detail_mvoucher_view', $data, true));
		...
		// Get output html
        $html = $this->load->view('modules/mspb/detail_mvoucher_view', $data, true);
	...
	public function editspb() {
		...
		$data['content'] = $this->load->view('modules/mspb/edit_mspb_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	...
	public function updatestatus() {
		...
		$data['content'] = $this->load->view('modules/mspb/update_mstatus_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
