...
class Mreportprpo extends CI_Controller
{
    ...
    public function index() {
		$data = [ 
			'drdnday' => json_encode($this->repmd->getreportprpoperday('MESRA')),
			'drdnmonth' => json_encode($this->repmd->getreportprpopermonth('MESRA')),
		...
		//echo json_encode($this->repmd->getreportprpoperday('MESRA')); exit;
		
		$data['content'] = $this->load->view('modules/mreport/mreport_prpo_view', $data, TRUE);
	...
	public function reportfilter() {
		...
		$data['content'] = $this->load->view('modules/mreport/mfilter_prpo_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	...
	public function exportfilter(){
		...
		$data = array( 'title' => 'Laporan Kontrak Mesra : '.$strftitle,
                'drd' => $this->repmd->getreportprpo($unit,$division,$segment,$statspb,$statinv,$fdate,$edate)); 
		/* $data = $this->repmd->getreportkomet();
		echo '<pre>';  
		print_r($data); exit; */
           $this->load->view('modules/mreport/mexport_prpo_view',$data);
	}	 
