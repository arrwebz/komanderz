...
class Kreportnps extends CI_Controller
{
    ...
    public function index() {
		$data = [ 
			'drdnday' => json_encode($this->repmd->getreportnopesperday('KOMET')),
			'drdnmonth' => json_encode($this->repmd->getreportnopespermonth('KOMET')),
		...
		$data['content'] = $this->load->view('modules/kreport/kreport_nopes_view', $data, TRUE);
	...
	public function reportfilter() {
		...
		$data['content'] = $this->load->view('modules/kreport/kfilter_nopes_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	...
	public function exportfilter(){
		...
		$data = array( 'title' => 'Laporan Invoice Komet : '.$strftitle,
                'drd' => $this->repmd->getreportnopes($unit,$division,$segment,$statspb,$statinv,$fdate,$edate)); 
		/* $data = $this->repmd->getreportkomet();
		echo '<pre>';  
		print_r($data); exit; */
           $this->load->view('modules/kreport/kexport_nopes_view',$data);
	}	 
