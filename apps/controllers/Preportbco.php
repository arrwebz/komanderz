...
class Preportbco extends CI_Controller
{
    ...
    public function index() {
		$data = [ 
			'drdnday' => json_encode($this->repmd->getreportbillcoperday('PADI')),
			'drdnmonth' => json_encode($this->repmd->getreportbillcopermonth('PADI')),
		...
		$data['content'] = $this->load->view('modules/preport/preport_billco_view', $data, TRUE);
	...
	public function reportfilter() {
		...
		$data['content'] = $this->load->view('modules/preport/pfilter_billco_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	...
	public function exportfilter(){
		...
		$strftitle = $strmonth.'/PADI';
		$data = array( 'title' => 'Laporan Collection PADI : '.$strftitle,
                'drd' => $this->repmd->getreportbillco($unit,$strmonth)); 
		/* $data = $this->repmd->getreportkomet();
		echo '<pre>';  
		print_r($data); exit; */
           $this->load->view('modules/preport/pexport_billco_view',$data);
	}	 
