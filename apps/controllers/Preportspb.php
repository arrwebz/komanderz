...
class Preportspb extends CI_Controller
{
    ...
    public function index() {
		$data = [ 
			'drdnday' => json_encode($this->repmd->getreportspbperday('PADI')),
			'drdnmonth' => json_encode($this->repmd->getreportspbpermonth('PADI')),
		...
		$data['content'] = $this->load->view('modules/preport/preport_spb_view', $data, TRUE);
	...
	public function reportfilter() {
		...
		$data['content'] = $this->load->view('modules/preport/pfilter_spb_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	...
	public function exportfilter(){
		...
		$data = array( 'title' => 'Laporan SPB Padi : '.$strftitle,
                'drd' => $this->repmd->getreportspb($unit,$division,$segment,$statspb,$payment,$fdate,$edate)); 
		/* $data = $this->repmd->getreportkomet();
		echo '<pre>';  
		print_r($data); exit; */
           $this->load->view('modules/preport/pexport_spb_view',$data);
	}	 
