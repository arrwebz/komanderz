...
class Papproval extends CI_Controller
{
    public $intspbid;
    public $intorderid;
    public $strcode;
    ...
    public function index() {
        ...
        $data['content'] = $this->load->view('modules/paprv/paprv_view', $data, TRUE);
    ...
    public function aprvspb() {
        ...
        $data['content'] = $this->load->view('modules/paprv/paprv_app_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
