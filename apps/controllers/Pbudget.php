...
class Pbudget extends CI_Controller
{
    public $intspbid;
    public $intorderid;
    public $strcode;
    ...
    public function index() {
        $data = [
            'drd' => $this->spbmd->getallbudget('PADI'),
            'title' => 'PADI',
        ...
        $data['content'] = $this->load->view('modules/pbudget/pbudget_view', $data, TRUE);
    ...
    public function addnewbudget() {
        $data = [
            ...
            'drd' => $this->spbmd->getallspbpaditoday('KOMET'),
        ...
        $data['content'] = $this->load->view('modules/pbudget/pbudget_add_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function createbudget()
    {
        if ($this->input->post()) {
            ...
            if($spbid == NULL){
                ...
                redirect(base_url().'pbudget/todaybudget/'.$budgetid);
            }
        }
    }
    ...
    public function todaybudget() {
        ...
        $data['content'] = $this->load->view('modules/pbudget/pbudget_today_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
    ...
    public function preview() {
        ...
        $name = 'Budget-PADI-'.$fdatename.'.pdf';
        ...
        // Get output html
        $html = $this->load->view('modules/pbudget/pbudget_print_view', $data, true);
    ...
    function previewspb(){
        ...
        $html = $this->load->view('modules/pbudget/pbudget_printspb_view', $data, true);
    ...
    function previewinvoice() {
        ...
        // Get output html
        $html = $this->load->view('modules/pbudget/pbudget_printinv_view', $data, true);
    ...
    public function export() {
        ...
        $fname = 'Anggaran-PADI-'.$fdate.$islpdb;
        ...
        /* echo '<pre>';
        print_r($data); exit; */
        $this->load->view('modules/pbudget/pbudget_export_view',$data);
    }
}