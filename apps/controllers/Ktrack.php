...
class Ktrack extends CI_Controller
{
    ...
    public function index() {
		...
		if($this->session->userdata('userid') == '21' || $this->session->userdata('userid') == '30' || $this->session->userdata('userid') == '36' || $this->session->userdata('userid') == '37' ) {
			$drd = $this->trkmd->getallinvoicebyam($amname,'KOMET');
		} else {
		...
		$data['content'] = $this->load->view('modules/ktrack/ktrack_view', $data, TRUE);
	...
	public function search() {
		...
		$data['content'] = $this->load->view('modules/ktrack/search_ktrack_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
    }
	...
	public function details() {
		...
		$data['content'] = $this->load->view('modules/ktrack/detail_ktrack_view', $data, TRUE);
        $this->load->view('templates/base', $data, FALSE);
	}
